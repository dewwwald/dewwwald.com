...
var where_component_1 = require('../components/where/where.component');
...
exports.routes = [
    ...
    { path: 'where', component: where_component_1.WhereComponent },
    { path: 'when', component: when_component_1.WhenComponent },
];
