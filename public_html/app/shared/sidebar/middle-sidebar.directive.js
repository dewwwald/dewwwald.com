...
var AppMenuDirective = (function () {
    function AppMenuDirective(el, window) {
...
], AppMenuDirective.prototype, "_resizeEventListiner", null);
AppMenuDirective = __decorate([
    core_1.Directive({
        selector: '[appMenu]',
        providers: [
...
exports.AppMenuDirective = AppMenuDirective;
