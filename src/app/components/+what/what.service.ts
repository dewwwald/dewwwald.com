    ...
    return [
      {
        img: {
          ...
          alt: 'dewwwald software engineering - bigteam.co feedback platform'
        },
        title: 'BigTeam',
      ...
      },
      {
        img: {
          ...
          alt: 'dewwwald software engineering - delvv.io website'
        },
      ...
      },
      {
        img: {
          ...
          alt: 'dewwwald software engineering - delvv.io Jules platform'
        },
        title: 'delvv.io Jules platform',
        description: "Platform built with Laravel 5.2; work included operations, database design, backend development, and frontend development. <br/><br/><small><em>Work done as a freelancer consulting for delvv.io.</em></small>",
        link: "http://app.delvv.io/"
      },
      {
        img: {
          url: 'https://dewwwald.com/assets/img/HS-shopfitter.jpg',
          alt: 'dewwwald software engineering - hs-shopfitters website screenshot'
        },
      ...
      },
      {
        img: {
          ...
          alt: 'dewwwald software engineering - Cafe Cazengo website screenshot'
        },
        title: 'Cafe Cazengo',
      ...
      },
      {
        img: {
          ...
          alt: 'dewwwald software engineering - The alter native website screenshot'
        },
      ...
      },
      {
        img: {
          ...
          alt: 'dewwwald software engineering - Dare to explore website screenshot'
        },
      ...
      },
      {
        img: {
          ...
          alt: 'dewwwald software engineering - Monarch and co website screenshot'
        },
        title: 'Monarch & Co',
      ...
      },
      {
        img: {
          ...
          alt: 'dewwwald software engineering - Click to drive website screenshot'
        },
